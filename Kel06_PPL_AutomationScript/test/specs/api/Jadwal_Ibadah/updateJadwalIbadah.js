...
describe('Update Jadwal Ibadah API', () => {
    it('should update Jadwal Ibadah successfully', async () => {
      // Set the parameters for the request
      const requestData = {
        id_jadwal_ibadah: 11,
        tgl_ibadah: "2023-06-04",
        nama_jenis_minggu: "Minggu Ke-5 Trinitatis",
        id_melayani: 4,
        jumlah_pelayan: 2,
        waktu_mulai: "12:01:32",
        keterangan: "Minggu Siang",
        nyanyian_1: "559 : 1 - 3",
        ...
        doa_penutup: "Amen, Amen, Amen"
                ...
                const response = await axios.post('http://127.0.0.1:8070/api/updateIbadah', requestData);
