...
describe('Add Registrasi Jemaat Gereja API', () => { 
    it('should Add Registrasi Jemaat Gereja successfully', async () => {
      const requestData = {
                id_registrasi : 8,
                ...
                const response = await axios.post('http://127.0.0.1:8070/api/storeRegistrasiJemaat', requestData);
