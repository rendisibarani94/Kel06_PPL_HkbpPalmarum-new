...
const LoginPage = require("./test/pageobjects/login.page2");
...
it("should display Daftar Baptis Baptis",async () =>{
  ...
  const TambahJemaatBaptisHeading = await $("#textHeader");
  expect(TambahJemaatBaptisHeading).toHaveText('Tambah Jemaat Baptis');
