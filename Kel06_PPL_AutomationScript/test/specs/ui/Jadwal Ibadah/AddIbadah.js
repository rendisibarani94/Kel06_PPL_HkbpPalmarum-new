...
describe("My Login application", () => {
  ...
  it("should display Daftar Jadwal Ibadah", async () => {
    const tambahjadwalibadahButton  = $("#buttonHeader")
    await tambahjadwalibadahButton.click();

   // expect(browser.getUrl()).toContain("http://127.0.0.1:8000/admin/daftarRpp");

    const tambahJadwalIbadahHeading = await $("#textHeader");
    expect(tambahJadwalIbadahHeading).toHaveText('Pendaftaraan Jadwal Ibadah');
